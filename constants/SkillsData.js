...
import { FaBootstrap, FaCss3Alt, FaAngular, FaPhp, FaShopify, FaJava, FaWordpress } from "react-icons/fa";
...
export const TechStackData = [
  {
    Advance: [
      ...
      },
      {
       ...
       {
        name: "Photoshop",
        icon: <SiAdobephotoshop  className="md:text-4xl text-2xl" color="#08668e" />
      },
       {
        name: "NextJS",
