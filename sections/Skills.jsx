        ...
        >
          <button
            className={`w-[120px] md:w-[150px] p-2 font-bold ${
              section === "Advance" ? "bg-blue-600 text-white dark:white dark:bg-red-600" : null
            } transition-all`}
            onClick={(e) => {
          ...
          <button
            className={`w-[120px] md:w-[150px] p-2 font-bold ${
              section === "Good" ? "bg-blue-600 text-white dark:white dark:bg-red-600" : null
          ...
          <button
            className={`w-[100px] md:w-[150px] p-2 font-bold ${
              section === "Familiar" ? "bg-blue-600 text-white dark:white dark:bg-red-600" : null
            } transition-all`}
            onClick={(e) => {
              setSection(e.target.innerText);
              if (section !== e.target.innerText)
